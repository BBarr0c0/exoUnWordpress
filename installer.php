...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Boris_Bar20221207_exounwordpress_844e1bd4fc25cb899711_20221207140229_archive.zip';
        const ARCHIVE_SIZE       = '28134145';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '844e1bd-07140229';
        const SECONDARY_PACKAGE_HASH = '3fa90b0-07140229';
        const VERSION            = '1.5.1';
